...
namespace LibraryApp
{
    public partial class LibTracker_Delete : Form
    {
        ...
        public LibTracker_Delete()
        {
            ...
            con.ConnectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=Library;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=True;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        ...
        {
            result = MessageBox.Show("Are you sure you want to delete this book record?",
            ...
            try
            {
                //if database contains a valid ISBN to delete and user confirms deletion with MessageBox
